...
namespace SwfLibrary.Abc
{
    public class ExceptionInfo : IExternalizeable
    {
        ...
        ///  ¸¨ÖúÊý¾Ý
        /// </summary>
        private AVM2Command fromCommand;

        public AVM2Command FromCommand
        {
            get { return fromCommand; }
            set { fromCommand = value; }
        }
        private AVM2Command toCommand;

        public AVM2Command ToCommand
        {
            get { return toCommand; }
            set { toCommand = value; }
        }
        private AVM2Command targetCommand;

        public AVM2Command TargetCommand
        {
            get { return targetCommand; }
