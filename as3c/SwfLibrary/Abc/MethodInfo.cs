...
namespace SwfLibrary.Abc
{
    public class MethodInfo : IExternalizeable
    {
        ...
        protected List<U30> _paramType;
        protected U30 _name;
        protected byte _flags;
        protected OptionInfo _optionInfo;
        protected List<U30> _paramName;
        ...
        public List<U30> ParameterNames
        {
        ...
        public void ReadExternal(BinaryReader input)
        {
            ...
            _paramType = new List<U30>(Capacity.Max(_paramCount));
            ...
            if (HasFlag(HasParamNames))
            {
                ...
                _paramName = new List<U30>(Capacity.Max(_paramCount));
        ...
        public void WriteExternal(BinaryWriter output)
        {
            ...
            for (int i = 0; i < n; ++i)
            {
                Primitives.WriteU30(output, _paramType[i]);
            }
            ...
            if (HasFlag(HasParamNames))
            {
                ...
                for (int i = 0; i < n; ++i)
                {
                    Primitives.WriteU30(output, _paramName[i]);
                }
            }
        }
