...
namespace SwfLibrary.Abc
{
    public class Abc46 : IExternalizeable
    {
        ...
        protected List<MetadataInfo> _metadata;
        protected List<InstanceInfo> _instanceInfo;
        protected List<ClassInfo> _classInfo;
        protected List<ScriptInfo> _scriptInfo;
        protected List<MethodBodyInfo> _methodBodyInfo;
        ...
        public void ReadExternal(BinaryReader input)
        {
            ...
            _methods = new List<MethodInfo>(Capacity.Max(n));
            ...
            _metadata = new List<MetadataInfo>(Capacity.Max(n));
            ...
            _instanceInfo = new List<InstanceInfo>(Capacity.Max(n));
            ...
            _classInfo = new List<ClassInfo>(Capacity.Max(n));
            ...
            for (uint i = 0; i < n; ++i)
            {
                ...
                _instanceInfo[(int)i].classInfo = classInfo;
            ...
            _scriptInfo = new List<ScriptInfo>(Capacity.Max(n));
            ...
            _methodBodyInfo = new List<MethodBodyInfo>(Capacity.Max(n));
