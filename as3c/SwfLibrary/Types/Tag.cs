...
using as3c.SwfLibrary.Types.Tags;
...
namespace SwfLibrary.Types
{
    public class Tag : IExternalizeable
    {
        ...
        public void ReadExternal(BinaryReader input)
        {
            ...
            {
                case 0x47:
                    _body = new ImportAssets2(this);
                    break;
                case 0x48:
                    _body = new DoABCDeprecated(this);
                ...
                case 0x4c:
                    _body = new SymbolClass(this);
                    _parent.AddSymbol((SymbolClass)_body);
                    break;
                
                case 0x0C ://DoAction
                    _body = new DoAction(this);
                    break;
        ...
        #endregion IExternalizeable Members
    }
}