...
namespace As3c.Common
{
    ...
    public class Translator
    {
        ...
        public static void InitTable()
        {
            ...
            _dictionary.Add(new AVM2Command("declocal", 0x94, 0));
            ...
            _dictionary.Add(new AVM2Command("finddef", "finddef", 0x5f, 1, new ParameterType[] { ParameterType.U30 }));
            ...
            for (int i = 0; i < 4; ++i)
            {
                _dictionary.Add(new AVM2Command("get_local" + i.ToString(), "getLocal" + i.ToString(), (byte)(0xd0 + i), 0));
            }
            ...
            _dictionary.Add(new AVM2Command("applyType", 0x53, 1, new ParameterType[] { ParameterType.U30 }));
            ...
            for (int i = 0; i < 4; ++i)
            {
                _dictionary.Add(new AVM2Command("set_local" + i.ToString(), "setLocal" + i.ToString(), (byte)(0xd4 + i), 0));
            }
            ...
            _dictionary.Add(new AVM2Command("SetByte", 0x3A,0));
            _dictionary.Add(new AVM2Command("SetShort", 0x3B, 0));
            _dictionary.Add(new AVM2Command("SetInt", 0x3C, 0));
            _dictionary.Add(new AVM2Command("SetFloat", 0x3D, 0));
            _dictionary.Add(new AVM2Command("SetDouble", 0x3E, 0));
            _dictionary.Add(new AVM2Command("GetByte", 0x35, 0));
            _dictionary.Add(new AVM2Command("GetShort", 0x36, 0));
            _dictionary.Add(new AVM2Command("GetInt", 0x37, 0));
            _dictionary.Add(new AVM2Command("GetFloat", 0x38, 0));
            _dictionary.Add(new AVM2Command("GetDouble", 0x39, 0));
            _dictionary.Add(new AVM2Command("Sign1", 0x50, 0));
            _dictionary.Add(new AVM2Command("Sign8", 0x51, 0));
            _dictionary.Add(new AVM2Command("Sign16", 0x52, 0));

            //unknowÁÐ±í
            _dictionary.Add(new AVM2Command("unknow", 0xDC, 0));
            _dictionary.Add(new AVM2Command("unknow", 0x0B, 0));
